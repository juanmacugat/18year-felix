...
Intimate, ambitious, timeless. Like a letter written from the past arriving in the future. Warm but not sentimental. Confident without being flashy. Bitcoin-native without being crypto-bro.

## Anti-references

- Generic crypto exchange dashboards (Coinbase, Binance, Bybit): data-dense, cold, transactional.
- Generic SaaS landing pages: "Join 10,000+ teams", gradient hero blob, identical feature cards.
- Neon-on-black crypto aesthetics: garish, low-trust, ephemeral feel.
- Baby shower / children's gift aesthetics: this is a gift for an adult-to-be, not a nursery card.
...
WCAG AA minimum. Reduced-motion preference respected (already partially implemented). No known specific user needs beyond standard browser accessibility.
